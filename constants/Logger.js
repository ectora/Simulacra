...
module.exports = class {
       ...
       * @param {*} logPath
       * @example 
       * new Logger(path.resolve(process.cwd() + '/logs/'))
       */
      constructor(logPath) {
      ...
      log(string = 'Empty response', optionalParams = []) {
            const date = new Date();
            const parseNumber = (number = 5) => (number.toString().length === 1 ? `0${number}` : number);
      ...
      info(string = 'Empty response', optionalParams = []) {
            const date = new Date();
            const parseNumber = (number = 5) => (number.toString().length === 1 ? `0${number}` : number);
      ...
      warn(string = 'Empty response', optionalParams = []) {
            const date = new Date();
            const parseNumber = (number = 5) => (number.toString().length === 1 ? `0${number}` : number);
      ...
      debug(string = 'Empty response', optionalParams = []) {
            const date = new Date();
            const parseNumber = (number = 5) => (number.toString().length === 1 ? `0${number}` : number);
      ...
      error(string = 'Empty response', optionalParams = []) {
            const date = new Date();
            const parseNumber = (number = 5) => (number.toString().length === 1 ? `0${number}` : number);
